	...
	<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
		...
		<tbody>
        	<form method="post" action="<?php echo site_url('teacher/attendance_selector');?>" class="form">
            	<tr class="gradeA">
                    <td>
			...
			foreach($students as $row)
			{
				...
				<tr class="gradeA">
					...
					<td align="center">
                        ...
                        <form method="post" action="<?php echo site_url('teacher/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id);?>">
